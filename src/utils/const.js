export default {
  ...
  RE: {
    ...
    SMSCODE: /^\d{4,6}$/,
    ACCOUNT: /(^[a-zA-Z]([a-zA-Z0-9_]{3,19})$)|(^(\+86)?1[3-9]\d{9}$)|(^[a-zA-Z0-9][a-zA-Z0-9]{2,19}@([a-zA-Z0-9]{1,}\.)+[a-zA-Z0-9]{2,}$)/
  },
  RE_TEXT: {
    PHONE_NUM: '请输入正确的手机号!',
    PASSWORD: '仅支持字母，数字与常见特殊符号',
    SMSCODE: '请输入4-6位验证码',
    ACCOUNT: '请输入正确的用户名、手机号等',
  },
  // IMG_BASEURL: 'http://attendance.keepdev.top/api',
  IMG_BASEURL: 'http://120.78.228.248:8080',

  // BASEURL: 'http://ad.keepdev.top:8080',
  // BASEURL: 'http://attendance.keepdev.top/api'
  BASEURL: 'http://120.78.228.248:8080',
}